...
`BadgePresentationRules.cs` 新增十一项，覆盖独立角色颜色与状态标记、姓名起点和四语双标签布局、完整姓名/拒绝原因提示、空床等待、严格门槛、实际达标对象、主人与兼任调教员的恶堕归属、已有床位保留，以及失效指定关系。
标签断言通过原版和 Mint 的已分配/未分配四条绘制路径；共 93 项通过。
